...
import { finaliserRapport } from "@/app/actions/rapports";
...
export function RapportEdition({ rapport, currentDossier, dossierChoix, onAnnuler }: Props) {
        ...
        {isVisite ? (
          ...
          <>
            ...
            {rapport.statut === "finalise" ? (
              ...
              <form
                action={finaliserRapport.bind(null, rapport.id)}
                className="flex-1"
              >
                <button
                  type="submit"
